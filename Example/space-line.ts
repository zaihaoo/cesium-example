import { Color, SpaceLine, Viewer } from 'cesium';
import { GUI } from 'dat.gui';
import { WGS84_POSITION } from './Types';
let _center_$1: WGS84_POSITION<true, false>;
let _center_$2: WGS84_POSITION<true, false>;
let _color: Color;
...
export const example = (viewer: Viewer, gui: GUI) => {
	...
	folder
		...
		.name('中心点')
		.onChange((v: string) => {
			_obj.center = { _center_$1: _center_$1, _center_$2: _center_$2 }[v] as [number, number];
		});
	folder
