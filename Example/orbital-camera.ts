import { Cartesian3, Cartographic, Cesium3DTileset, Color, HeadingPitchRange, Matrix4, Viewer } from 'cesium';
import { GUI } from 'dat.gui';
import CameraRoutePlanning from './Lib/CameraRoutePlanning';

let _controls: Cartesian3[];
let _viewer: Viewer;
const _loadTestData = () => {
	_controls = [
