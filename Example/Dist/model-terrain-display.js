import { Cartesian3, Cesium3DTileset, Color, Matrix4, Model, Transforms } from '../Lib/Cesium/index.js';
let _viewer;
let _glb;
let _tileset;
const deploy = {
...
const _loadTestData = async () => {
    _tileset = _viewer.scene.primitives.add(await Cesium3DTileset.fromUrl('Assets/File/Model/cliff/tileset.json', {
        maximumScreenSpaceError: 0,
    }));
    const car3 = _tileset.boundingSphere.center;
    const _car3 = Cartesian3.multiplyByScalar(car3, -1, new Cartesian3());
    let ma = Matrix4.fromTranslation(Cartesian3.fromElements(-2599091.2989332466, 4237304.23421351, 3983739.1323248832));
    Matrix4.multiplyByScale(ma, new Cartesian3(70, 70, 70), ma);
    _tileset.modelMatrix = Matrix4.multiplyByTranslation(ma, _car3, ma);
    _glb = _viewer.scene.primitives.add(await Model.fromGltfAsync({
...
//# sourceMappingURL=model-terrain-display.js.map