import { Cartesian3, Color, ContinuousPoint, NearFarScalar, PointPrimitiveSpriteType } from '../Lib/Cesium/index.js';
export const example = (viewer, gui) => {
    ...
    const pointCollection = viewer.scene.primitives.add(ContinuousPoint(interpolate(pos), {
...
/** 对两个点进行插值*/
function interpolateTwoPoint(p1, p2) {
    let interpolatedPoints = [];
