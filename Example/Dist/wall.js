import { Cartesian2, Cartesian3, Color, Entity, WallFocusMaterialProperty, WallPaddingMaterialProperty, WallTextureMaterialProperty, WallArrowMaterialProperty, } from '../Lib/Cesium/index.js';
export const example = (viewer, gui) => {
    ...
    let style;
    (function (style) {
        style[style["texture"] = 0] = "texture";
        style[style["padding"] = 1] = "padding";
        style[style["focus"] = 2] = "focus";
        style[style["succession"] = 3] = "succession";
        style[style["section"] = 4] = "section";
    })(style || (style = {}));
    const _material = {};
    ...
    const obj = viewer.entities.add(new Entity({
        wall: {
