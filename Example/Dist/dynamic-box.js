import { Cartesian3, Color, CompositeProperty, ConstantProperty, JulianDate, SampledPositionProperty, SampledProperty, TimeInterval, Entity, LerpByHeightAndColorMaterialProperty, } from '../Lib/Cesium/index.js';
function _createBox(lng, lat, bottom, top, second, bottomColor, topColor) {
    ...
    compositeProperty.intervals.addInterval(new TimeInterval({
        start: now,
        stop: end,
        data: property,
    }));
    ...
    compositePositionProperty.intervals.addInterval(new TimeInterval({
        start: now,
        stop: end,
...
//# sourceMappingURL=dynamic-box.js.map