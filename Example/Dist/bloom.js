import { BoxGeometry, Cartesian3, Cesium3DTileFeature, Color, EllipsoidSurfaceAppearance, GeometryInstance, Label, Material, Model, ModelAnimationLoop, Primitive, ScreenSpaceEventHandler, ScreenSpaceEventType, Transforms, VertexFormat, Entity, GridMaterialProperty, Cartesian2, } from '../Lib/Cesium/index.js';
let _viewer;
let _gltf_model;
let _box;
let _box_entity;
