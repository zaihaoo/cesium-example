import { Cartesian3, Color, PolylineArrowsSlideMaterialProperty } from '../Lib/Cesium/index.js';
let _viewer;
const _obj = [];
...
function parabolaEquation(options, resultOut = undefined) {
...
export const example = (viewer, gui) => {
    ...
    for (var j = 0; j < cities.length; j++) {
        ...
        _obj.push(_viewer.entities.add({
    ...
    folder
        ...
        .onChange(v => {
        _obj.forEach(entity => {
            (entity.polyline?.material).color = Color.fromCssColorString(v);
        });
    });
};
const _enable = () => {
...
//# sourceMappingURL=polyline-arrows-slide.js.map