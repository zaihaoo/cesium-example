import { CameraEventType, Cartographic, EventHelper, Math, Ray, Rectangle, ScreenSpaceEventHandler, ScreenSpaceEventType, defined, } from '../Lib/Cesium/index.js';
import { LatLng, TileLayer } from '../Lib/leaflet/leaflet-src.esm.js';
let _viewer;
let _map2D;
let active2D = false;
let active3D = false;
...
export const example = (viewer, map2D, gui) => {
    gui.addFolder('二三维联动');
    _viewer = viewer;
    _map2D = map2D;
    // 初始化视角
    ...
    viewer.camera.changed.addEventListener(function () {
        ...
        // 级别
        let level = viewer.scene.globe._surface._debug.maxDepthVisited;
    ...
    handler.setInputAction(function (v) {
        active3D = true;
        wheelChange = true;
        wheel = v > 0 ? 1 : 0;
    ...
    const layer = new TileLayer('https://server.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer/tile/{z}/{y}/{x}', {
        maxZoom: 22,
...
//# sourceMappingURL=leaflet-linked.js.map