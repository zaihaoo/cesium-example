import { Color, GeoJsonDataSource, RoadWay } from '../Lib/Cesium/index.js';
let _data_source;
let _style_$1;
let _color;
...
export const example = async (viewer, gui) => {
    _viewer = viewer;
    await _loadTestData();
    _obj = new RoadWay({ data_source: _data_source, style: _style_$1, width: 3, speed: 12, color: _color }, true, (prev_primitive, primitive, _key, _value) => {
...
//# sourceMappingURL=road-way.js.map