import { Cartesian3, Cartographic, Color, GeometryInstance, GroundPolylineGeometry, GroundPolylinePrimitive, PolylineGeometry, PolylineMaterialAppearance, PolylineMeteorMaterial, Primitive, PrimitiveCollection, } from '../Lib/Cesium/index.js';
let _positions;
// 0,2,4,1,3,0
const _loadTestData = () => {
    _positions = [
...
export const example = (viewer, gui) => {
    ...
    _primitives.add(new GroundPolylinePrimitive({
